 ...
 *  displays odd and even numbers on given interval, their sum
 *  and also it counts percentage of odd and even Fibonacci numbers
 *  on given interval
 * <p>
 * @author  AlexDex
 * @version 1.0
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            /**checking if interval numbers are positive*/
                ...
                System.out.print("Please Enter positive numbers for evaluation of odd and even numbers");
                throw new InputMismatchException();
            }
        }
        ...
        try {
            ...
            /**Checking if at least one number in Fibonacci and making sure there won't be 0 division */
            if (FibMaxSet >= 1) {
